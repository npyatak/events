...
class ShareWidget extends \yii\base\Widget 
{
    ...
    public function run() {
	    ...
	    $share = $this->share;
	    $share['image_fb'] = $share['image_fb'] ? Url::to(Yii::$app->image->getImageUrl($share['image_fb']), true) : Url::to(Yii::$app->image->getImageUrl($share['image']), true);
	    $share['image_tw'] = $share['image_tw'] ? Url::to(Yii::$app->image->getImageUrl($share['image_tw']), true) : Url::to(Yii::$app->image->getImageUrl($share['image']), true);
