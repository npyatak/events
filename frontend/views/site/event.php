...
if($this->params['is_mobile']) {
    ...
    $imageUrl = Yii::$app->image->getImageUrl($event->image_url);
}?>
        ...
        <div class="event-wrap">
            ...
            <div class="event-content" id="article">
                ...
                <?php if($event->copyright):?>
                    <div class="container_inner">
                        <div class="copyright">
                            <span><?=$event->copyright_title;?></span>
                            <?=$event->copyright;?>
                        </div>
                    </div>
                <?php endif;?>
            ...
            <div class="event-right-content">
                ...
                <?php endif;?>
                <div class="no_main">
                    <?php if(Yii::$app->controller->yearModel->partner_url):?>
                        ...
                        <div class="partner_refer">
                            <a class="image" target="_blank" href="<?=Yii::$app->controller->yearModel->partner_url;?>" style="background-image: url(<?=Yii::$app->image->getImageUrl(Yii::$app->controller->yearModel->partner_image_event);?>);"></a>
                            <?php if(Yii::$app->controller->yearModel->partner_text):?>
                                <a class="text" target="_blank" href="<?=Yii::$app->controller->yearModel->partner_url;?>"><?=Yii::$app->controller->yearModel->partner_text;?></a>
                            <?php endif;?>
                        </div>
                    <?php endif;?>
                </div>
