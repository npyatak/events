                ...
                <div class="no_main">
                    <?php if(Yii::$app->controller->yearModel->partner_url):?>
                        ...
                        <div class="partner_refer">
                            <a class="image" href="<?=Yii::$app->controller->yearModel->partner_url;?>" target="_blank" style="background-image: url(<?=Yii::$app->image->getImageUrl(Yii::$app->controller->yearModel->partner_image_event);?>);"></a>
                            <?php if(Yii::$app->controller->yearModel->partner_text):?>
                                <a class="text" href="<?=Yii::$app->controller->yearModel->partner_url;?>" target="_blank"><?=Yii::$app->controller->yearModel->partner_text;?></a>
                            <?php endif;?>
                        </div>
                    <?php endif;?>
                </div>
