			...
			<aside>
				...
				<?php if(Yii::$app->controller->yearModel->partner_url):?>
					...
					<div class="partner_refer m-t-30">
                        <a class="image" href="<?=Yii::$app->controller->yearModel->partner_url;?>" target="_blank" style="background-image: url(<?=Yii::$app->image->getImageUrl(Yii::$app->controller->yearModel->partner_image_index);?>);"></a>
